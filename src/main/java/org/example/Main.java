...
public class Main {
    public static void main(String[] args) {
        ...
        //Задание 5 (Не доделано)

//        int maxCount = 3;
//        List<User> userWithMaxCountFavourites = users.stream().filter(if(user -> user.getFavoriteBooks().size() > maxCount)).toList();
//
//        System.out.println();
//        userWithMaxCountFavourites.forEach(user -> System.out.println(user.getName() + ": " + user.getFavoriteBooks().size()));
